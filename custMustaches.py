...
mustaches = ["mustache/111-removebg-preview.png",
         "mustache/112-removebg-preview.png",
         "mustache/113-removebg-preview.png",
         "mustache/114-removebg-preview.png",
         "mustache/115-removebg-preview.png",
         "mustache/116-removebg-preview.png",
         "mustache/117-removebg-preview.png",
         "mustache/118-removebg-preview.png",
         "mustache/119-removebg-preview.png"]

customimgs = mustaches
