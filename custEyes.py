...
eyes = ["eyes/1231-removebg-preview.png",
       "eyes/1232-removebg-preview.png",
       "eyes/1233-removebg-preview.png",
       "eyes/1234-removebg-preview.png",
       "eyes/1235-removebg-preview.png",
       "eyes/1236-removebg-preview.png",
       "eyes/1237-removebg-preview.png",
       "eyes/1238-removebg-preview.png",
       "eyes/1239-removebg-preview.png"]
...
def place(event):
    ...
    if x > x_org+int(cust.shape[1]/2) and x < 511-int(cust.shape[1]/2) and y > y_org+int(cust.shape[0]/2) and y < 533-int(cust.shape[0]/2) :
        x = x - x_org
        y = y - y_org
        custjup = fn.blendWithTransparent(jupbg, cust, cust.shape[1], cust.shape[0], x-int(cust.shape[1]/2), y-int(cust.shape[0]/2))
...
def choosecust(path,button,n):
        ...
        custjup = fn.blendWithTransparent(jupbg, cust, cust.shape[1], cust.shape[0], 200, 200)
        custjup = cv2.cvtColor(custjup, cv2.COLOR_BGRA2BGR)
        cv2.imwrite("img.png", custjup)
        # global image_image_2
        image_image_2.configure(file="img.png")
